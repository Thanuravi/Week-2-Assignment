...
public class Abibus {
	...
	public static void main(String[] args) {
		...
		WebElement seats5 = driver.findElement(By.xpath("//span[contains(text(),'Seat Selected :')]"));
		System.out.println(seats5.getText());
		WebElement seats6 = driver.findElement(By.xpath("//span[contains(text(),'Base Fare :')]"));
		System.out.println(seats6.getText());
